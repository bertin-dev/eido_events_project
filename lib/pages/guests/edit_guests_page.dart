...
class EditGuestsPageView extends StatefulWidget {
  static const String pageName = "guests/edit_guests_page";
  const EditGuestsPageView({Key? key}) : super(key: key);

  @override
  State<EditGuestsPageView> createState() => _EditGuestsPageViewState();
}

class _EditGuestsPageViewState extends State<EditGuestsPageView> {
                            ...
                            children: <Widget>[
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  const Text("Modifier un invité", style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: whiteColor),textAlign: TextAlign.left,),
                                ],
                              ),
                            ],
                          ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Image.asset("assets/images/guests/profil-img.png"),
                        ),
                        const SizedBox(height: 20,),
                        ...
                        ItextFieldImgIcon(
                          ...
                          textColor: bottomNavUnSelected,
                          prefix: Image.asset("assets/images/guests/email.png", width: 32, height: 32,),
                          hintText: "patriciaella@gmail.com",
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                ...
                                                const Text("L'Invité a été Modifié",
