...
class SearchRubriqueProgramPageView extends StatefulWidget {
  const SearchRubriqueProgramPageView({Key? key}) : super(key: key);
  static const String pageName = "manage_rubrique/search_rubrique_program";

  @override
  _SearchRubriqueProgramState createState() => _SearchRubriqueProgramState();
}

class _SearchRubriqueProgramState extends State<SearchRubriqueProgramPageView> {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Wrap(
                    ...
                    children: const [
                      Text("Il y a pas de programme pour le moment veuillez en créer",
                  ...
                  child: CustomButtonRightIcon(
                    ...
                    onPressed: () async {
                      Navigator.of(context, rootNavigator: true)
                          .pushNamed(AddRubriqueProgramPageView.pageName);
                    },
                    pHorizontal: 40.0,
                    pVertical: 10.0,
                    radius: 100.0,
