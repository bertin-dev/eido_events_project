...
class _HomePageViewState extends State<HomePageView> {
  ...
  List<BottomSheetMenu> listBottomSheetMenu = [
    BottomSheetMenu("Configuration de Salle", Image.asset("assets/images/home_page/config-salle.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xffC90A42)),//successTextColor
    BottomSheetMenu("Modèles du billet", Image.asset("assets/images/home_page/model-billet.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xff90C700)),
    BottomSheetMenu("Planning de l'évènement", Image.asset("assets/images/home_page/planing-event.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xff9300C7)),
    BottomSheetMenu("Partager le lien invité", Image.asset("assets/images/home_page/partager-lien.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), Colors.red),
    BottomSheetMenu("Liste des rubriques", Image.asset("assets/images/home_page/list-rubrique.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xff05A400)),
    BottomSheetMenu("Liste des invités", Image.asset("assets/images/home_page/list-invite.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xff0800FF)),
    BottomSheetMenu("Liste des comptes associés", Image.asset("assets/images/home_page/liste-compte-associe.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xffFF00B9)),
    BottomSheetMenu("Visualiser le QR Code", Image.asset("assets/images/home_page/see-qrcode.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xff2097F6)),
    BottomSheetMenu("Details de l'évènement", Image.asset("assets/images/home_page/details-event.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xff002040 )),
    BottomSheetMenu("Suivi des activités", Image.asset("assets/images/home_page/suivi-activite.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xff00B0BC)),
    BottomSheetMenu("Reporter l'évènement", Image.asset("assets/images/home_page/reporter-event.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xffC90A42)),
    BottomSheetMenu("Supprimer l'évènement", Image.asset("assets/images/home_page/supprimer-event.png", width: 20, height: 20,), const Icon(Icons.arrow_forward_ios, size: 16,), const Color(0xffDE1306)),
  ];
